...
const AboutUs = () => {
  ...
  const { stats: statsData, loading: statsLoading } = useSelector((state) => state.stats);
  ...
  const displayStats = statsData ? [
    { value: statsData.totalCustomers, label: 'Happy Customers' },
    { value: statsData.totalOrders, label: 'Products Delivered' },
    { value: statsData.totalProducts, label: 'Design Templates' },
    { value: statsData.averageRating, label: 'Average Rating' },
  ] : [
